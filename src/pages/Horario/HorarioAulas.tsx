...
import ImgLivro from '../../../assets/IMG/ImgLivro.png';
import ImgLampada from '../../../assets/IMG/ImgLampada.png';
import globo from '../../../assets/IMG/ImgLivro.png';
import roma from '../../../assets/IMG/ImgLivro.png';
import LinearGradient from 'react-native-linear-gradient'; // Importando o LinearGradient

const { width, height } = Dimensions.get('window'); // Importando as dimensões da tela
      ...
      <ScrollView>
        ...
        <View style={styles.Main}>
          ...
          <View style={[styles.caixaMateria1, isExpanded1 && styles.caixaMateria1Expandida]}>
            ...
            <Image source={ImgLivro} style={[styles.ImgLivro]} />
          ...
          <View style={[styles.caixaMateria2, isExpanded2 && styles.caixaMateria2Expandida]}>
            ...
            <Image source={ImgLampada} style={[styles.ImgLampada]} />
          ...
          <View style={[styles.caixaMateria1, isExpanded3 && styles.caixaMateria1Expandida]}>
            ...
            <Image source={globo} style={[styles.ImgLivro]} />
          ...
          <View style={[styles.caixaMateria2, isExpanded4 && styles.caixaMateria2Expandida]}>
            ...
            <Image source={roma} style={[styles.ImgLivro]} />
            ...
            {isExpanded4 && (
              ...
              <TouchableOpacity>
                <Text style={styles.Editar}>Editar</Text> {/*fazer aqui que quando clicar em editar ele possa editar a mensagem presente no conteudo ministrado e faaça um update como nova mensagem*/}
              </TouchableOpacity>
              </View>
